...
public static partial class CheckValidatorsExtensions
{
    ...
    /// <returns></returns>
    public static Check<List<T>> IfEmpty<T>(this Check<List<T>> data, string? msg = null)
    {
    ...
    /// <param name="msg">The custom error</param>
    /// <returns></returns>
    public static Check<List<T>> IfNotEmpty<T>(this Check<List<T>> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        try
        {
    ...
    /// <param name="msg">The custom error</param>
    /// <returns></returns>
    public static Check<List<T>> IfCount<T>(this Check<List<T>> data, int count, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        try
        {
    ...
    /// <param name="msg">The custom error</param>
    /// <returns></returns>
    public static Check<List<T>> IfNotCount<T>(this Check<List<T>> data, int count, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        try
        {
    ...
    /// <param name="msg">The custom error</param>
    /// <returns></returns>
    public static Check<List<T>> IfCountGreaterThan<T>(this Check<List<T>> data, int count, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        try
        {
    ...
    /// <param name="msg">The custom error</param>
    /// <returns></returns>
    public static Check<List<T>> IfCountLessThan<T>(this Check<List<T>> data, int count, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        try
        {
