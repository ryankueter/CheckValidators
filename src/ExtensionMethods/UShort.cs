...
public static partial class CheckValidatorsExtensions
{
    ...
    /// <returns></returns>
    public static Check<ushort> IfNegative(this Check<ushort> data, string? msg = null)
    {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<ushort> IfPositive(this Check<ushort> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value > 0)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<ushort> IfZero(this Check<ushort> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value is 0)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<ushort> IfNotZero(this Check<ushort> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<ushort> IfGreaterThan(this Check<ushort> data, ushort value, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value > value)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<ushort> IfLessThan(this Check<ushort> data, ushort value, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value < value)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<ushort> IfEquals(this Check<ushort> data, ushort value, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value == value)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<ushort> IfNotEquals(this Check<ushort> data, ushort value, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value != value)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<ushort> IfBetween(this Check<ushort> data, ushort startValue, ushort endValue, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<ushort> IfNotBetween(this Check<ushort> data, ushort startValue, ushort endValue, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value < startValue || data.Value > endValue)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<ushort> IfBetweenOrEqual(this Check<ushort> data, ushort startValue, ushort endValue, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value >= startValue && data.Value <= endValue)
        {
