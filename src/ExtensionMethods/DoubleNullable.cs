...
public static partial class CheckValidatorsExtensions
{
    ...
    /// <returns></returns>
    public static Check<double?> IfNegative(this Check<double?> data, string? msg = null)
    {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<double?> IfPositive(this Check<double?> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value > 0)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<double?> IfZero(this Check<double?> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value is 0)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<double?> IfNotZero(this Check<double?> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<double?> IfGreaterThan(this Check<double?> data, double value, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value > value)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<double?> IfLessThan(this Check<double?> data, double value, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value < value)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<double?> IfEquals(this Check<double?> data, double value, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value == value)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<double?> IfNotEquals(this Check<double?> data, double value, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value != value)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<double?> IfBetween(this Check<double?> data, double startValue, double endValue, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<double?> IfNotBetween(this Check<double?> data, double startValue, double endValue, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value < startValue || data.Value > endValue)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<double?> IfBetweenOrEqual(this Check<double?> data, double startValue, double endValue, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value >= startValue && data.Value <= endValue)
        {
