...
public static partial class CheckValidatorsExtensions
{
    ...
    /// <returns></returns>
    public static Check<DateTimeOffset> IfUtcTime(this Check<DateTimeOffset> data, string? msg = null)
    {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotUtcTime(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value.Offset != new TimeSpan(0, 0, 0))
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfDefault(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotDefault(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (data.Value != default)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfEarlierThan(this Check<DateTimeOffset> data, DateTimeOffset dateTime, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (DateTimeOffset.Compare(data.Value, dateTime) < 0)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfLaterThan(this Check<DateTimeOffset> data, DateTimeOffset dateTime, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (DateTimeOffset.Compare(data.Value, dateTime) > 0)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfEqual(this Check<DateTimeOffset> data, DateTimeOffset dateTime, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (DateTimeOffset.Compare(data.Value, dateTime) is 0)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotEqual(this Check<DateTimeOffset> data, DateTimeOffset dateTime, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (DateTimeOffset.Compare(data.Value, dateTime) != 0)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfBetween(this Check<DateTimeOffset> data, DateTimeOffset startTime, DateTimeOffset endTime, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if ((DateTimeOffset.Compare(data.Value, startTime) >= 0) && (0 >= DateTimeOffset.Compare(data.Value, endTime)))
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotBetween(this Check<DateTimeOffset> data, DateTimeOffset startTime, DateTimeOffset endTime, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if ((DateTimeOffset.Compare(data.Value, startTime) < 0) || (0 < DateTimeOffset.Compare(data.Value, endTime)))
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfDayLightSavingsTime(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotDayLightSavingsTime(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if (!TimeZoneInfo.Local.IsDaylightSavingTime(data.Value))
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfDaysOlderThan(this Check<DateTimeOffset> data, double days, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if ((DateTimeOffset.Now - data.Value).TotalDays > days)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotDaysOlderThan(this Check<DateTimeOffset> data, double days, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if ((DateTimeOffset.Now - data.Value).TotalDays <= days)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfMinutesOlderThan(this Check<DateTimeOffset> data, double minutes, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if ((DateTimeOffset.Now - data.Value).TotalMinutes > minutes)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotMinutesOlderThan(this Check<DateTimeOffset> data, double minutes, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if ((DateTimeOffset.Now - data.Value).TotalMinutes <= minutes)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfSecondsOlderThan(this Check<DateTimeOffset> data, double seconds, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if ((DateTimeOffset.Now - data.Value).TotalSeconds > seconds)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotSecondsOlderThan(this Check<DateTimeOffset> data, double seconds, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if ((DateTimeOffset.Now - data.Value).TotalSeconds <= seconds)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfMillisecondsOlderThan(this Check<DateTimeOffset> data, double milliseconds, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if ((DateTimeOffset.Now - data.Value).TotalMilliseconds > milliseconds)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotMillisecondsOlderThan(this Check<DateTimeOffset> data, double milliseconds, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        if ((DateTimeOffset.Now - data.Value).TotalMilliseconds <= milliseconds)
        {
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfSunday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotSunday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfMonday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotMonday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfTuesday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotTuesday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfWednesday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotWednesday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfThursday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotThursday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfFriday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotFriday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfSaturday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
    ...
    /// <param name="msg">Custom error message</param>
    /// <returns></returns>
    public static Check<DateTimeOffset> IfNotSaturday(this Check<DateTimeOffset> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
