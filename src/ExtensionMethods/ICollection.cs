...
public static partial class CheckValidatorsExtensions
{
    ...
    /// <returns></returns>
    public static Check<ICollection<T>> IfEmpty<T>(this Check<ICollection<T>> data, string? msg = null)
    {
    ...
    /// <param name="msg">The custom error</param>
    /// <returns></returns>
    public static Check<ICollection<T>> IfNotEmpty<T>(this Check<ICollection<T>> data, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        try
        {
    ...
    /// <param name="msg">The custom error</param>
    /// <returns></returns>
    public static Check<ICollection<T>> IfCount<T>(this Check<ICollection<T>> data, int count, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        try
        {
    ...
    /// <param name="msg">The custom error</param>
    /// <returns></returns>
    public static Check<ICollection<T>> IfNotCount<T>(this Check<ICollection<T>> data, int count, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        try
        {
    ...
    /// <param name="msg">The custom error</param>
    /// <returns></returns>
    public static Check<ICollection<T>> IfCountGreaterThan<T>(this Check<ICollection<T>> data, int count, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        try
        {
    ...
    /// <param name="msg">The custom error</param>
    /// <returns></returns>
    public static Check<ICollection<T>> IfCountLessThan<T>(this Check<ICollection<T>> data, int count, string? msg = null)
    {
        if (data.InvalidModel()) { return data; }
        try
        {
